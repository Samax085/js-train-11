...
console.log(filterAndAdd(new Set([1, 2, 3, "a", "b", "c"]), ["d", "a", "e", "f"]));
// Виведе: Set(6) { 'a', 'b', 'c', 'd', 'e', 'f' }
...
function setToArray(mySet) {
  ...
  arr = arr.filter((value) => typeof value === "string")   
